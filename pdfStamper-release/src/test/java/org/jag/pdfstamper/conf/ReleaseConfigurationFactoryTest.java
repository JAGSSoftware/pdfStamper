 ...
 */
public class ReleaseConfigurationFactoryTest {

    private ReleaseConfigurationFactory underTest;

    @Before
    public void setUp() throws Exception {
        underTest = ReleaseConfigurationFactory.getInstance();
    }
    ...
    public void singletonInstance() {
        final ReleaseConfigurationFactory instance = ReleaseConfigurationFactory.getInstance();
    ...
    public void configurationPropertiesDoesNotExist() {
        final ReleaseConfigurationFactory instance = ReleaseConfigurationFactory.getInstance("doesNotExist");
